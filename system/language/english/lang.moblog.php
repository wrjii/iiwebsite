...
"When enabled, this moblog will not post weblog entries.  It will only save your files to the specified upload location.",

'weblog_id_subtext' =>
"If no weblog is chosen, this moblog will not post weblog entries.  It will only save your files to the specified upload location.",
